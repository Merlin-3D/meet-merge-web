...
export default function Footer({ muted, setMuted, desableVideo }: FooterProps) {
  return (
        ...
        <div className="col-span-9 flex flex-row items-center justify-center gap-x-4">
          <button
            ...
            className={classNames(
              { "bg-primary-red hover:bg-primary-red-accent": muted },
              { "bg-primary-blue hover:bg-primary-blue-accent": !muted },
              "rounded-full p-3 group"
            )}
          >
            {muted ? (
              <SoundMuteIcon className="text-primary-white group-hover:text-primary-red h-6 w-6" />
            ) : (
              <SoundIcon className="text-primary-white group-hover:text-primary-blue h-6 w-6" />
            )}
          </button>
          <button
            onClick={desableVideo}
            className="rounded-full bg-primary-blue hover:bg-primary-blue-accent p-3 group"
          >
